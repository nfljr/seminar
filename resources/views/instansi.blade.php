            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="{{ route('instansi.create') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                <div class="form-group">
                                    <label class="col-md-12">Penerima Kunjungan</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Masukkan Penerima Kunjungan" name="name" value="{{ old('name') }}"
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Durasi Kunjungan</label>
                                    <div class="col-md-12">
                                        <input type="text" value="" class="form-control form-control-line @error('alamat') is-invalid @enderror" placeholder="Masukkan Durasi Kunjungan/Jam" name="alamat" value="{{ old('alamat') }}">
                                            @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" class="form-control form-control-line @error('alamat') is-invalid @enderror" placeholder="Masukkan Jumlah Snack" name="snack" value="{{ old('snack') }}">
                                            @error('snack')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    </div>
